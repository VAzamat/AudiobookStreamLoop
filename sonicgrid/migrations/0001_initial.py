# Generated by Django 5.2.12 on 2026-03-16 17:17
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('book_uuid', models.UUIDField(editable=False, primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            name='Contributor',
            fields=[
                ('contributor_uuid', models.UUIDField(editable=False, primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('role', models.CharField(choices=[('author', 'Author'), ('editor', 'Editor'), ('corrector', 'Corrector'), ('illustrator', 'Illustrator'), ('translator', 'Translator')], max_length=100, verbose_name='Вклад в книгу')),
                ('book', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='sonicgrid.book')),
                ('contributor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='sonicgrid.contributor')),
            ],
        ),
        migrations.AddField(
            model_name='book',
            name='contributors',
            field=models.ManyToManyField(related_name='books', through='sonicgrid.BookContributor', to='sonicgrid.contributor'),
        ),
        migrations.AddField(
            model_name='book',
            name='copyrighter',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='books', to='sonicgrid.copyrighter', verbose_name='Копирайтер'),
        ),
        migrations.AddField(
            model_name='book',
            name='genres',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='books', to='sonicgrid.genre', verbose_name='Жанры'),
        ),
        migrations.AddField(
            model_name='book',
            name='publisher',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='books', to='sonicgrid.publisher', verbose_name='Издатель'),
        ),
        migrations.AddField(
            model_name='book',
            name='rating',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='books', to='sonicgrid.rating', verbose_name='Рейтинг'),
        ),
        migrations.AddField(
            model_name='book',
            name='rightholder',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='books', to='sonicgrid.rightholder', verbose_name='Правообладатель'),
        ),
